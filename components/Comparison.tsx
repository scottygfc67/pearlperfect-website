            ...
            <div className="divide-y divide-gray-200">
              {comparisonData.map((row) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <div className="bg-purple-50 text-pp-purple-700 px-4 py-2 rounded-lg font-semibold">
                      {row.pearlPerfect}
                    </div>
                  </div>
            ...
            >
              <div className="text-center mb-6">
                <h3 className={`text-xl font-bold ${
                  product.highlight ? 'text-purple-600' : 'text-gray-900'
                }`}>
                  {product.name}
                </h3>
                {product.highlight && (
                  <p className="text-purple-600 font-semibold mt-1">Our Choice</p>
                )}
              </div>
